          ...
          <div className="mb-4 overflow-x-auto pb-2">
            <div className="flex space-x-2">
              <button
                ...
                className={`px-4 py-2 rounded-lg font-medium transition-all ${
                  activeTab === "all"
                    ...
                    : "bg-blue-500 text-white/80 hover:bg-blue-700"
                }`}
              >
                All Transactions
              </button>
              ...
              <select
                ...
                className="px-4 py-2 rounded-lg bg-gray-200 text-gray-800 font-medium capitalize"
              >
                {transactionTypes.map((type) => (
                  <option
                    key={type}
              ...
              <tbody>
                {noDataAvailable ? (
                  ...
                  currentTransactions.map((item, index) => (
                    <tr
                      key={index}
                      className="border-b border-slate-700/50 transition-all hover:bg-gray-100"
                    >
            ...
            <table className="min-w-full text-left text-sm">
              <thead className="bg-gradient-to-r from-blue-900 to-blue-700 border-b border-blue-500">
                <tr className="border-b border-slate-700 text-white">
                  ...
                  {table_name !== "cto_transaction" && (
                    <th className="px-2 sm:px-4 py-3 whitespace-nowrap">ID</th>
                  )}
                  <th className="px-2 sm:px-4 py-3 whitespace-nowrap">
                    Amount
                  </th>
                  <th className="px-2 sm:px-4 py-3 whitespace-nowrap">Type</th>
                  {table_name !== "reward_transaction" &&
                    table_name !== "cto_transaction" && (
                      <>
                        <th className="px-2 sm:px-4 py-3 whitespace-nowrap">
              ...
              <tbody>
                {noDataAvailable ? (
                  ...
                  currentTransactions.map((item, index) => (
                    <tr
                      key={index}
                      className="border-b border-slate-700/50 hover:bg-gray-100 transition-all"
                    >
                      <td className="px-2 sm:px-4 py-3 whitespace-nowrap text-slate-800">
                        {(currentPage - 1) * entriesPerPage + index + 1}
                      </td>
                      {table_name !== "cto_transaction" && (
                        <td className="px-2 sm:px-4 py-3 whitespace-nowrap text-slate-800">
                      ...
                      <td className="px-2 sm:px-4 py-3 whitespace-nowrap">
                        <span
                          className={`px-2 py-1 capitalize rounded-full text-xs font-medium ${getTransactionTypeClass(
                            item
                          )}`}
                        >
                          {table_name === "invest_level_transaction"
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className={`px-4 py-2 rounded-lg flex items-center gap-1 transition-all ${
                currentPage === 1
                  ? "bg-slate-700/50 text-slate-100 cursor-not-allowed"
              ...
              {totalPages > 5 && currentPage < totalPages - 2 && (
                <>
                  ...
                  <button
                    ...
                    className="w-10 h-10 flex items-center justify-center rounded-lg bg-slate-700/50 text-slate-200 hover:bg-slate-100 transition-all"
                  >
                    {totalPages}
                  </button>
                </>
