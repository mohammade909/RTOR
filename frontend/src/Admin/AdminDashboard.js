                ...
                <section>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-4">
                    {cards.map((item, i) => (
                      <div
                        key={i}
                        className="relative bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden transition-all duration-300 hover:shadow-md hover:translate-y-[-2px]"
                      >
                        {/* Gradient overlay */}
                        <div
                        ...
                        <div
                          className={`absolute inset-0 opacity-10 ${
                            i % 4 === 0
                              ...
                              : "bg-gradient-to-br from-lime-200 to-lime-400"
                          }`}
                        ></div>
