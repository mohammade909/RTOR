            ...
            <div className="max-w-2xl">
              ...
              <div className="relative mb-6">
                ...
                <h1 className="sm:text-3xl text-2xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                  Get in Touch with  <span className="text-amber-600">R2R</span> Globle
                </h1>
              </div>
              
              <p className="sm:text-xl text-gray-700 mb-8 leading-relaxed">
                We’re here to help you start, grow, and succeed in your hotel investment journey. Whether you have questions about a package, need support, or want to partner with us—reach out anytime. Our dedicated team is ready to guide you every step of the way. Your success is our priority.
              </p>
            </div>
          </div>
