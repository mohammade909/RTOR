          ...
          <div className="w-full lg:w-1/2 mb-12 lg:mb-0">
            <div className="max-w-2xl">
              ...
              <nav className="flex items-center space-x-2 text-sm mb-8">
                ...
                <span className="text-amber-700 font-medium">Services</span>
              </nav>
              ...
              <div className="relative mb-6">
                ...
                <h1 className="sm:text-3xl text-2xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                  Smart  <span className="text-amber-600">Hotel Investment</span> Services
                </h1>
              </div>
              
              <p className="sm:text-xl text-gray-700 mb-8 leading-relaxed">
                R2R Globle offers a seamless way to invest in real, income-generating hotels around the world. Our services are designed for simplicity, security, and long-term profitability. Whether you're starting small or scaling big, we've got the right solution for you.
              </p>
            </div>
          </div>
