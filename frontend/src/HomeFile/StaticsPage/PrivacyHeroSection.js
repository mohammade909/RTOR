          ...
          <div className="w-full lg:w-1/2 mb-12 lg:mb-0">
            <div className="max-w-2xl">
              ...
              <p className="sm:text-xl text-gray-700 mb-8 leading-relaxed">
                At R2R Globle, we prioritize your privacy and the protection of your personal information. This policy explains how we collect, use, and secure your data when you use our platform. We are committed to maintaining transparency and trust with all our users.
              </p>
            </div>
          </div>
