          ...
          <div className="w-full lg:w-1/2 mb-12 lg:mb-0">
            <div className="max-w-2xl">
              ...
              <nav className="flex items-center space-x-2 text-sm mb-8">
                ...
                <span className="text-amber-700 font-medium">Our Team</span>
              </nav>
              ...
              <div className="relative mb-6">
                ...
                <h1 className="sm:text-3xl text-2xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                  Meet the People Behind <span className="text-amber-600">R2R</span> Globle
                </h1>
              </div>
              
              <p className="sm:text-xl text-gray-700 mb-8 leading-relaxed">
                 At R2R Globle, our strength lies in the people who power our platform. From seasoned professionals in hospitality and finance to tech innovators and investment experts, our team brings diverse expertise with a shared commitment to your success. We work behind the scenes to ensure your hotel investments are secure, profitable, and seamless.
              </p>
            </div>
          </div>
